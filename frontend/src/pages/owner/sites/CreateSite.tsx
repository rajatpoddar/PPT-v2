...
export function CreateSite() {
  ...
  const mutation = useMutation({
    mutationFn: (data: typeof form) =>
      sitesApi.create({
        ...
        total_contract_value: data.total_contract_value ? parseFloat(data.total_contract_value) : undefined,
    ...
    onError: (err: unknown) => {
      ...
      toast.error(msg || "Failed to create site");
    },
  });
  ...
  return (
    <div>
      <PageHeader title="Create New Site" backTo="/sites" />
